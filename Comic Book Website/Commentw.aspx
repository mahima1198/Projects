<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeFile="Commentw.aspx.cs" Inherits="Commentw" %>
...
body {
   background-image: url("Backsignlogin.jpg");
...
form Textbox:focus { background-color: rgba(0,0,0,.4); }
...
#BackToWolverine:hover, #BackToWolverine:focus {
  background: #179b77;
}
...
<body>
    ...
    <br />
    <asp:TextBox ID="UserName" placeholder="write your UserName" runat="server" Width="266px" ></asp:TextBox> 
    <asp:TextBox ID="commentf" placeholder="write a comment here" runat="server" Width="266px" ></asp:TextBox>
      
    <br />
        <br />
    
    <asp:Button ID="Submit" runat="server" Text="Submit Your Comment" Width="266px" OnClick="Submit_Click" />
    <br />
    <asp:Button ID="BackToWolverine" runat="server" Text="Back" Width="266px" CausesValidation="False" PostBackUrl="~/Wolverine.aspx" />
