...
public partial class Commentb : System.Web.UI.Page
{
    ...
    protected void Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string insertQuery = "insert into commentb(UserName,Comments) values(@username,@commentb)";
            SqlCommand cmd = new SqlCommand(insertQuery, con);
            cmd.Parameters.AddWithValue("@username", UserName.Text);
            cmd.Parameters.AddWithValue("@commentb", commentb.Text);
