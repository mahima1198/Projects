<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Commentf.aspx.cs" Inherits="Commentf" %>
...
#BackToFlash:hover, #BackToFlash:focus {
  background: #179b77;
}
...
<body>
    ...
    <br />
        <asp:TextBox ID="UserName" placeholder="write your UserName" runat="server" Width="232px"></asp:TextBox> 
    <asp:TextBox ID="commentf" placeholder="write a comment here" runat="server" Width="232px"></asp:TextBox>
      
    <br />
        <br />
    
    <asp:Button ID="Submit" runat="server" Text="Submit Your Comment" Width="265px" OnClick="Submit_Click" />
    <br />
    <asp:Button ID="BackToFlash" runat="server" Text="Back" Width="265px" CausesValidation="False" PostBackUrl="~/Flash.aspx" />
