<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Commentb.aspx.cs" Inherits="Commentb" %>
...
#BackToBatman:hover, #ViewComment:focus {
  background: #179b77;
}
          </style>
...
<body>
    ...
    <br />
        <asp:TextBox ID="UserName" placeholder="write your UserName" runat="server" Width="233px"></asp:TextBox> 
    <asp:TextBox ID="commentb" placeholder="write a comment here" runat="server" Width="234px"></asp:TextBox>
    ...
    <br />
    <asp:Button ID="BackToBatman" runat="server" Text="Back" Width="266px" CausesValidation="False" PostBackUrl="~/Batman.aspx" />
